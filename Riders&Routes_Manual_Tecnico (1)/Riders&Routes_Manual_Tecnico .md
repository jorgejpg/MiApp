Riders & Routes![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.001.png)![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.002.png)

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.003.png)





Versión Android App **2022.0** Versión React App **2022.0** Versión Functions Express API **1.0** Última modificación **22/05/2022**

**ÍNDICE DE CONTENIDOS SECCIÓN**

**ÍNDICE DE CONTENIDOS GENERALES**

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.004.png)

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.005.png)

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.006.png)

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.007.png)

Almacenamiento, seguridad y configuraciones del

servidor

**Almacenamiento de datos FIRESTORE** 8 - 12![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.008.png)

1. Datos de usuarios
1. Datos de rutas y subelementos
1. Datos de mensajería de usuarios

**Almacenamiento de ficheros STORAGE** 13 - 14

\1. Herarquía de carpetas y ficheros de

usuarios

**Seguridad y configuración del servidor** 15

\1. Reglas de seguridad para firestore y storage

Riders & Routes Android Client

**Estructura del modelo** 16 - 22![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.009.png)

1. Servicios Web
1. Local Cache
1. Repositorios

**Estructura de la vista y los controladores** 23 - 24

\1. Estructura de las vistas, los activities, los fragmentos y los controladores

Riders & Routes Supervisor React Client

**Estructura del modelo** 0 - 0![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.010.png)

1. Servicios Web
1. Controladores

**Estructura de la vista y los controladores** 0 - 0
...
**Mapbox Directions API** 0 - 0![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.011.png)

Conexión securizada con Mapbox

**Manipular base de datos cómo** 0 - 0 **administrador**

Manipulación de base de datos con llaves de administrador

Dado que los códigos de la versión del servidor, la API y los clientes que describe este documento son confidenciales, **se prohíbe distribuir este documento técnico.**
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.012.png)
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.013.png)
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.014.png)
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.015.png)
...
public class Repository![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.016.png)
...
public interface OnRepositoryFailureListener {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.017.png)

void onFailure(Exception exception);

}

public interface OnRepositorySuccessListener<R> {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.018.png)
...
@Override![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.019.png)
...
public Repository isNicknameUsed(String nickname) {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.020.png)
...
miButton.setOnClickListener(view -> { Repository.newInstance(getApplicationContext())![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.021.png)
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.022.png)Para navegar entonces por la ventana principal se debe usar la clase utilidad y la función:

MainActivityWindowLoader.getInstance().open(new MainFragment());![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.023.png)

A continuación puede ver el flujo que se ejecuta al cargar una nueva ventana, menú superior o inferior en el MainActivity:

![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.024.png)
...
; (ASCII) , (%2C) ; (%3B) Example: -18.000000000,16.000000000;-19.000000000,15.00000000 0 => -18.000000000%2C16.000000000%3B-19.000000000%2C15 .000000000
...
router.get('/newMapiResponse', isAuthenticated, function (req, res) {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.029.png)
...
// Command![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.030.png)
...
const getAuthToken = (req, res, next) => {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.031.png)
...
req.authId = userInfo.uid;![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.032.png)
...
const getRouteRequestUrlByAsciiSeparation = (waypoints) => {![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.033.png)
...
![](Aspose.Words.3a166126-417e-4631-9492-1c8e0c7e34c5.034.png)
Dado que los códigos de la versión del servidor, la API y los clientes que describe este documento son confidenciales, **se prohíbe distribuir este documento técnico.**
